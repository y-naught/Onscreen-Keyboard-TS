export default class Keyboard{
    ...
    private keys : Key[];
    private layoutToggle : boolean;
    private shiftToggle : boolean;

    constructor(dom : Document, _w : number, _h : number, clss : string){
        this.dom = dom;
        this.width = _w;
        this.height = _h;
...
class Key {
    ...
    private keyDiv : HTMLDivElement;
    private keyText : HTMLParagraphElement;
    private text : string;
    ...
    private keyCase : boolean; // convention : false = lower, true = higher
    private altKey : boolean; // convention : true = altkey, false = normal letter

    constructor(text : string, altText : string, spacing : number, type : string, dom : Document, parent : Keyboard){
        this.text = text; this.altText = altText; this.spacing = spacing; this.dom = dom; 
        this.keyType = type; this.keyCase = false; this.altKey; this.parent = parent;

        const keyDiv = this.dom.createElement('div') as HTMLDivElement;
        const keyText = this.dom.createElement('p') as HTMLParagraphElement;
    ...
    setInputTarget(input : HTMLInputElement){
        this.inputTarget = input;
    }
